...
public class EmployeeWeekInfoCellTable extends CellTable<EmployeeWeekInfo> {
    ...
    public void fulfill(List<EmployeeWeekInfo> employeeWeekInfoList) {
        ...
        for (int i = 0; i < employeeWeekInfoList.size(); i++) {
            ...
            if (userLoginInfo.getRole().equals(Roles.Employee)) {
                if (!employeeWeekInfo.getMonday().isEmpty()) {
                    if (employeeWeekInfo.getMonday().get(0).getWorkingTimeStart().toString().substring(11, 13).equals("00"))
                        getRowElement(i).addClassName("rejectRow");
                } else if (!employeeWeekInfo.getTuesday().isEmpty()) {
                    if (employeeWeekInfo.getTuesday().get(0).getWorkingTimeStart().toString().substring(11, 13).equals("00"))
                        getRowElement(i).addClassName("rejectRow");
                } else if (!employeeWeekInfo.getWednesday().isEmpty()) {
                    if (employeeWeekInfo.getWednesday().get(0).getWorkingTimeStart().toString().substring(11, 13).equals("00"))
                        getRowElement(i).addClassName("rejectRow");
                } else if (!employeeWeekInfo.getThursday().isEmpty()) {
                    if (employeeWeekInfo.getThursday().get(0).getWorkingTimeStart().toString().substring(11, 13).equals("00"))
                        getRowElement(i).addClassName("rejectRow");
                } else if (!employeeWeekInfo.getFriday().isEmpty()) {
                    if (employeeWeekInfo.getFriday().get(0).getWorkingTimeStart().toString().substring(11, 13).equals("00"))
                        getRowElement(i).addClassName("rejectRow");
                } else if (!employeeWeekInfo.getSaturday().isEmpty()) {
                    if (employeeWeekInfo.getSaturday().get(0).getWorkingTimeStart().toString().substring(11, 13).equals("00"))
                        getRowElement(i).addClassName("rejectRow");
                } else if (!employeeWeekInfo.getSunday().isEmpty()) {
                    if (employeeWeekInfo.getSunday().get(0).getWorkingTimeStart().toString().substring(11, 13).equals("00"))
                        getRowElement(i).addClassName("rejectRow");
                }
            }
        }
